...
uses
  ...
  {$endif}                       
  ColnEdit,
  VirtualTrees, MsgDecodeVirtualTree, VTHeaderPopup;
...
begin
  RegisterComponents('Virtual Controls', [TVirtualStringTree, TMsgDecodeVirtualTree, TVirtualDrawTree, TVTHeaderPopupMenu]);
